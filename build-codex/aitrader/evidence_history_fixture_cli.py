"""Read an artificial evidence revision history without persistence."""
...
from .evidence_history_fixture import inspect_evidence_history
...
def main(argv=None):
    try:
        parser = _Parser(description='人工証拠の取得・訂正履歴をメモリ内で検査します。')
