"""Read a v2 offline history/validity binding bundle without persistence."""
from __future__ import annotations

import json
import sys

from .history_validity_binding_v2 import inspect_history_validity_binding
...
def main(argv=None):
    try:
        parser = _Parser(description='人工履歴と適用期間の結合 v2 をメモリ内で検査します。')
